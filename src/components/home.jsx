  ...
  return (
    <section id='home' className='text-center mt-20 pb-10'>
          <span className='ml-auto mr-auto relative text-center font-bold typin font-align-center font-dev text-6xl text-white'>Ethereal Devs</span>
            <div>
              <div class="mt-24 mapa">
              </div>
            </div>

            <p className='mt-10 mb-60 text-center text-white text-lg px-72'>
                <span className='font-bold text-2xl'>
                Bienvenido(a), somos Ethereal Devs
                </span> 
                <br />
          ...
          <div className="pt-32 animate-bounce-slow ">
          ...
          <div>
            <p className='mt-10 text-center text-slate-400 italic text-sm px-72'>

          ...
          <div className="items-center mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className=" h-20 items-center">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <img src="./eth.png" class="h-20 mr-3" alt="Flowbite Logo" />
                </div>
                <div className="ml-10 text-center justify-center hidden sm:ml-6 sm:block">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          'rounded-md px-3 py-2 text-sm font-medium ml-64'
                        )}
